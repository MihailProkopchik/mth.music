const API_URL = 'http://devlab.kz:3024/';
...
const createCard = data => {
    ...
    <img class="track__poster" src="${API_URL}${data.poster}" alt="${data.artist} ${data.track}" />
    </div>
...
const checkCount = (i = 1) => {
    tracksCard[0];
    if (catalogContainer.clientHeight < 10) {
        return console.log('нечего не найдено');
    } else if (catalogContainer.clientHeight + 20 > tracksCard[0].clientHeight * 3) {
